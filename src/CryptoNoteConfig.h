...
const uint64_t CRYPTONOTE_MAX_BLOCK_NUMBER                   = 900000000;
const size_t   CRYPTONOTE_MAX_BLOCK_BLOB_SIZE                = 400000000;
const size_t   CRYPTONOTE_MAX_TX_SIZE                        = 990000000;
...
const size_t   BLOCKCHAIN_TIMESTAMP_CHECK_WINDOW             = 40;
...
const size_t   CRYPTONOTE_COINBASE_BLOB_RESERVED_SIZE        = 1000;
...
const char     CRYPTONOTE_NAME[]                             = "RUB";
...
const size_t   COMMAND_RPC_GET_BLOCKS_FAST_MAX_COUNT         =  500;
